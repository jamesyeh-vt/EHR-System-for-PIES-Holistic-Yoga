        ...
        {filtered.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="absolute top-0 left-0 h-full w-1 bg-gradient-to-b from-purple-400 to-purple-600" />
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-5 bg-gradient-to-r from-purple-600 to-purple-300 transition pointer-events-none" />
            </li>
          );
        })}
      </ul>
